...
class crawler:
    def __init__(self):
        ...
        self.__areaList = {"全部主題":0, "綜合討論":1,"瑪娜回收":2, "攻略心得":3, "日服公會":4, "台版專區":5,
        ...
        self.__information ='''
            ----------------------請輸入要訪問哪版------------------------------------
            全部主題, 綜合討論,瑪娜回收, 攻略心得, 日服公會, 台版專區, 日服專區, 版友創作,
            集中討論, 板物公告, 社群交流, 食殿公會, 抱怨小屋, 遊戲實況, 設備問題, 劇情討論,
            陸板專區, 陸服公會, 外掛專區, 真布公會, 破曉公會, 韓板專區
            '''
    ...
    def get_url(self,name):
        ...
        if name in self.__areaList:
            ...
            start_urls = self.baseUrl %(str(page),str(0))
        ...
        for sing in total :
            ...
            areaName = sing.xpath('//*[@id="BH-master"]/form/div/table/tbody/tr[11]/td[1]/p/a')
